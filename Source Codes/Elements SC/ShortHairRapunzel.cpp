...
void display()
{
    ...
    //hair
    glBegin(GL_POLYGON);
    glColor3d(1.0, 1.0, 0.0); glVertex3f(-0.25, 0.1, 6.0);
    glColor3d(1.0, 1.0, 0.0); glVertex3f(0.25, 0.1, -0.0);
    glColor3d(1.0, 1.0, 0.0); glVertex3f(0.25, -0.3, -0.0);
    glColor3d(1.0, 1.0, 0.0); glVertex3f(-0.25, -0.3, 6.0);
    glEnd();
