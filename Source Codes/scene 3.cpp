...
float musicNotes_move = 0.0f;
float musicNotes_move2 = 0.0f;
float musicNotes_move3 = 0.0f;
...
void drawMusicNotes(float x, float y, double r) {
	for (int i = 0; i < 4; i++) {
		//circle
		float m1;
		float n1;
...
void rock()
{
	//rock 1
	glColor3f(0.4784, 0.451, 0.4471);
	circleRock(-0.14, -0.55, 0.25);
	glFlush();

	//rock 2
	glColor3f(0.1, 0.1, 0.1);
	circleRock(-0.08, -0.57, 0.25);
	glFlush();

	//rock 3
	glColor3f(0.439, 0.502, 0.565);
	circleRock(-0.20, -0.62, 0.5);
	glFlush();
...
void display() {
	...
	bushes();
		...
		glPushMatrix();
		glTranslatef(musicNotes_move, 0.0, 0.0);
		musicNotes();
		glPopMatrix();

		musicNotes_move += 0.005;
		{
			if (musicNotes_move > 1.9)
			{
				musicNotes_move = -0.15;
			}
		}

		glPushMatrix();
		glTranslatef(musicNotes_move2, 0.0, 0.0);
		musicNotes2();
		glPopMatrix();

		musicNotes_move2 += 0.015;
		{
			if (musicNotes_move2 > 1.9)
			{
				musicNotes_move2 = -0.15;
			}
		}

		glPushMatrix();
		glTranslatef(musicNotes_move3, 0.0, 0.0);
		musicNotes3();
		glPopMatrix();

		musicNotes_move3 += 0.010;
		{
			if (musicNotes_move3 > 1.9)
			{
				musicNotes_move3 = -0.15;
			}
		}
